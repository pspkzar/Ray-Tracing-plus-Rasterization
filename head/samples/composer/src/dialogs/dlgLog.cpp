...
DlgLog::DlgLog(): wxDialog(DlgLog::m_Parent, -1, wxT("Slanger - LOG"),wxDefaultPosition,
...
void
DlgLog::eventReceived(const std::string &sender, const std::string &eventType, curitiba::event_::IEventData *evt)
{
	if (eventType == "LOG") {
