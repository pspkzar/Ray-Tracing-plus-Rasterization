...
namespace curitiba
{
	namespace event_
	{
		...
		public:
			...
			//virtual void setProximitySensor(std::string name, bool enabled, curitiba::math::vec3 center, curitiba::math::vec3 size){};
			//virtual void setTimeSensor(std::string name, bool enabled, int secondsToStart, int cicleInterval, bool loop){};
			//virtual void setTouchSensor(std::string name, ISceneObject *object, bool enabled, curitiba::math::vec3 colorSensitive){};
