...
#include <curitiba/geometry/distancemap.h>
...
DistanceMap::makeRasterDistanceMap(unsigned int pr, unsigned int pc)
{
	...
	TexImage * texPixelCoords = curitiba::material::TexImage::create(pixelCoords);
	...
	TexImage * texTriangleIDs = curitiba::material::TexImage::create(triangleIDs);
