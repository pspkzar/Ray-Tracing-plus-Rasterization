#include <curitiba/loader/cbsloader.h>

#include <curitiba.h>

#include <curitiba/scene/isceneobject.h>
...
#include <curitiba/render/renderablefactory.h>
...
void 
CBSLoader::loadScene (curitiba::scene::IScene *aScene, std::string &aFilename)
{
...
//				int pos = 0;
				...
				//		f.ignore (sizeof (curitiba::render::GlState));
...
void 
CBSLoader::writeScene (curitiba::scene::IScene *aScene, std::string &aFilename)
{
