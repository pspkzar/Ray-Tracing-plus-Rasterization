...
void 
Octree::_getAllObjects (std::vector<curitiba::scene::SceneObject*> &m_vReturnVector)
{
	std::vector<curitiba::scene::OctreeNode*> tmpVector (10000);
	...
	//std::vector<curitiba::scene::OctreeNode*>::iterator objIter;
...
void 
Octree::_place (curitiba::scene::SceneObject *aSceneObject)
{
	static std::list<curitiba::scene::OctreeNode*> tmpVector;
	static int octant = 0;
...
void 
Octree::updateOctreeTransform(curitiba::math::ITransform *t)
{
