...
//void
//OctreeNode::addRenderable (curitiba::render::IRenderable *aRenderable)
//{
//	
...
void 
OctreeNode::updateNodeTransform(curitiba::math::ITransform *t)
{
	if (0 != m_pLocalMesh) {
...
void 
OctreeNode::setRenderable (curitiba::render::IRenderable *aRenderable)
{
