...
void
Scene::eventReceived(const std::string &sender, const std::string &eventType, curitiba::event_::IEventData *evt)
{
...
void
Scene::setTransform(curitiba::math::ITransform *t)
{
	m_Transform->clone(t);
...
void
Scene::transform(curitiba::math::ITransform *t)
{
