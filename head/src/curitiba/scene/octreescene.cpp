...
void
OctreeScene::eventReceived(const std::string &sender, const std::string &eventType, curitiba::event_::IEventData *evt)
{	
...
void
OctreeScene::setTransform(curitiba::math::ITransform *t)
{
	m_Transform->clone(t);
	updateSceneObjectTransforms();
}
...
void
OctreeScene::transform(curitiba::math::ITransform *t)
{
